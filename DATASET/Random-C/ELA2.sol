...
contract ELA2 is ERC20, ERC20Detailed /* ERC20Burnable, ERC20Mintable, ERC20Pausable,*/ {
    ...
    constructor(string memory name, string memory symbol, uint8 decimals, uint256 totalsupply) ERC20Detailed(name, symbol, decimals) public {
        _building_address = "12, Nonhyeon-ro 68-gil, Gangnam-gu, Seoul, Republic of Korea, 06228, no.202";
