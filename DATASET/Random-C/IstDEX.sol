...
contract Owned {
    ...
    constructor() public {
        owner = 0xD6082bF63c0452766c30660522c6e36F96C817f5;
    }
...
// ----------------------------------------------------------------------------
contract IstDEX is ERC20Interface, Owned {
    ...
    constructor() public {
        ...
        name = "IstDEX";
        decimals = 18;
        _totalSupply = 2750000 * 10**uint(decimals);
        balances[owner] = _totalSupply;
        RATE = 20000000; // 1 ETH = 2000 HUBS
        DENOMINATOR = 10000;
