...
//Creadit <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="582b31332d3539183f312c302d3a">[email protected]</a>
...
contract LOLPreToken is StandardToken, Ownable {
    ...
    function getRateAt(uint256 at) constant returns (uint256) {
        if (at < startDate) {
            ...
            return 2720; //<a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="a5e9eae9f5e5">[email protected]</a> 0.05
        }
    }
